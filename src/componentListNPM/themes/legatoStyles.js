    ...
    getstyles() {
        ...
        let styles = {
            ...
            colors: {fontFamily: fontApp.appFont,
                color1: colorpick.color1,
                color2: colorpick.color2,
                color3: colorpick.appBlack,
                color4: colorpick.color1,
                color5: colorpick.color2,
